                  ...
                  <div className="mt-4 mb-2">
                    <div className="flex justify-between text-xs text-gray-600 mb-1">
                      ...
                      <span>
                        {Math.min(
                          processingData.gptData.total_sections,
                          (processingData?.jsonData?.json?.sections?.length ||
                            0) +
                            (processingData?.jsonData?.json?.form_title ? 1 : 0)
                        )}{" "}
                        of {processingData.gptData.total_sections} sections
                      </span>
                    </div>
                    <div className="h-2 bg-gray-200 rounded overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min(
                            100,
                            (((processingData?.jsonData?.json?.sections
                              ?.length || 0) +
                              (processingData?.jsonData?.json?.form_title
                                ? 1
                                : 0)) /
                              processingData.gptData.total_sections) *
                              100
        ...
        return (
          <>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {processingData?.sectionData?.sections?.map((section, idx) => {
                  const isProcessed =
                    statuses[3] === "complete" ||
                    (statuses[3] === "processing" &&
                    ...
                    >
                      <button
                        onClick={() => {
                          ...
                          updatedExpandedSections[idx] = !expandedSections[idx];
                        ...
                        <div className="flex items-center">
                          ...
                          >
                            {isProcessed ? (
                              ...
                              idx ===
                                processingData.gptData.total_sections - 1 ? (
                              <svg
                                className="animate-spin h-3 w-3 text-yellow-500"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                  ...
                                  {isProcessed && (
                                    <div className="flex space-x-2">
                                      <button
                                        ...
                                        onClick={() => {
                                          const text = section.name.includes(
                                            "title"
                                          )
                                            ? JSON.stringify(
                                                {
